...
namespace Orleans.TestingHost
{
    ...
    public class TestClusterBuilder
    {
        ...
        public TestClusterBuilder(short initialSilosCount)
        {
            ...
            this.ConfigureFileLogging = true;
        }
        ...
        {
            get => (Guid)this.Properties["ServiceId"];
            set => this.Properties["ServiceId"] = value;
        }
        ...
        {
            get => (bool)this.Properties["ConfigureFileLogging"];
            set => this.Properties["ConfigureFileLogging"] = value;
        }
        ...
        public TestCluster2 Build()
        {
            ...
            var defaultConfigurationSource = new Dictionary<string, string>
            {
                ...
                ["ConfigureFileLogging"] = this.ConfigureFileLogging.ToString(),
            };
