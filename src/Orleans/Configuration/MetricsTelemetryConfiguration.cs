...
namespace Orleans.Runtime.Configuration
{
    ...
    public class MetricsTelemetryConfiguration
    {
        ...
        public void Add(string typeName, string assemblyName, IEnumerable<KeyValuePair<string, object>> properties)
        {
            ...
            if (!typeof(IMetricTelemetryConsumer).IsAssignableFrom(pluginType)) throw new InvalidOperationException($"TelemetryConsumer class {typeName} must implement one of {nameof(ITelemetryConsumer)} based interfaces");
