// This was created to be able to serialize System.Exception, as well as derived exceptions (without copying other fields from them)
// as a workaround for not having BinaryFormatter (and exceptions being serializable natively)
